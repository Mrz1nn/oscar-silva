      ...
      <Container className="max-w-2xl">
        <Reveal className="text-center">
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="mt-10 flex w-full items-center justify-center gap-3 rounded-full bg-gold px-6 py-4 font-display text-sm font-bold uppercase tracking-wide text-navy shadow-sm transition-transform hover:-translate-y-0.5 sm:mt-10 sm:inline-flex sm:w-auto sm:px-8"
          >
            <svg viewBox="0 0 24 24" className="h-5 w-5 shrink-0 fill-navy" aria-hidden>
